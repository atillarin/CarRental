...
namespace Business.Concrete
{
    public class CarImageManager : ICarImageService
    {
        ...
        {
            IResult result = BusinessRules.Run(CheckCarImageLimitExceded(carImage.CarId));
        ...
        {
            return new SuccessDataResult<CarImage>(_carImageDal.Get(c=>c.Id==id), Messages.ProductListed);
        }



        private IResult CheckCarImageLimitExceded(int CarId)
        {
